...
import com.example.sti_agent.operation_fragment.OtherInsurance.OtherInsureFragment1;

import butterknife.BindView;
import butterknife.ButterKnife;

public class OtherInsuredForm extends AppCompatActivity {



    @BindView(R.id.otherform_toolbar)
    Toolbar toolBar;
   ...
   /* @BindView(R.id.message)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment = new OtherInsureFragment1();
    ...
    private void showFragment(Fragment fragment) {
        ...
        ft.replace(R.id.fragment_other_form_container, fragment);
        ft.commit();
    }
}
